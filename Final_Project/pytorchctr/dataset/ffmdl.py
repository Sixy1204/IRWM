...
if __name__ == '__main__':
    ...
    def main(dataset, imp_dataset):
        ...
        data_loader = DataLoader(sim_dataset, batch_size=8000, num_workers=0, shuffle=False) #worker_init_fn=worker_init_fn, sampler=srs(sample_list))
    ...
    imp_dataset = FFMDataset(dataset_path=sys.argv[1], data_prefix='va', rebuild_cache=False, read_flag=1)
